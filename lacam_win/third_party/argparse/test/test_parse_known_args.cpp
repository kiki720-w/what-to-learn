...
TEST_CASE("Parse unknown optional && positional arguments without exceptions" *
          test_suite("parse_known_args")) {
  argparse::ArgumentParser program("test");
  program.add_argument("--foo").implicit_value(true).default_value(false);
  program.add_argument("bar");

  SUBCASE("Parse unknown optional && positional arguments") {
    auto unknown_args =
...
TEST_CASE("Parse unknown optional && positional arguments in subparsers "
          "without exceptions" *
          test_suite("parse_known_args")) {
  argparse::ArgumentParser program("test");
  ...
  SUBCASE("Parse unknown positional && optional arguments") {
  ...
  SUBCASE("Parse unknown positional && optional arguments 2") {
    auto unknown_args =
