...
TEST_CASE("Parse positional nargs=1..2 arguments" *
          test_suite("positional_arguments")) {
  GIVEN("a program that accepts an optional argument && nargs=1..2 positional "
        "arguments") {
    argparse::ArgumentParser program("test");
    ...
    WHEN("provided no argument") {
      THEN("the program does ! accept it") {
...
TEST_CASE("Parse positional nargs=ANY arguments" *
          test_suite("positional_arguments")) {
  GIVEN("a program that accepts an optional argument && nargs=ANY positional "
        "arguments") {
    argparse::ArgumentParser program("test");
    program.add_argument("-o");
    ...
    WHEN("provided no argument") {
      THEN("the program accepts it && gets empty container") {
...
TEST_CASE("Parse remaining arguments deemed positional" *
          test_suite("positional_arguments")) {
  GIVEN("a program that accepts an optional argument && remaining arguments") {
    argparse::ArgumentParser program("test");
    program.add_argument("-o");
...
TEST_CASE("Reversed order nargs is ! allowed" *
          test_suite("positional_arguments")) {
  argparse::ArgumentParser program("test");
