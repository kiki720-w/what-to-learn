...
TEST_CASE(
    "Parse required arguments which are ! set && don't have default value" *
...
TEST_CASE("Parse required arguments which are set as empty value && don't "
          "have default value" *
          test_suite("required_arguments")) {
  argparse::ArgumentParser program("test");
  program.add_argument("--output", "-o").required();
...
TEST_CASE("Parse required arguments which are set as some value && don't have "
          "default value" *
          test_suite("required_arguments")) {
  argparse::ArgumentParser program("test");
  program.add_argument("--output", "-o").required();
...
TEST_CASE("Parse required arguments which are ! set && have default value" *
          test_suite("required_arguments")) {
  argparse::ArgumentParser program("test");
...
TEST_CASE(
    "Parse required arguments which are set as empty && have default value" *
    test_suite("required_arguments")) {
  argparse::ArgumentParser program("test");
  program.add_argument("--output", "-o")
      .required()
...
TEST_CASE("Parse required arguments which are set as some value && have "
          "default value" *
          test_suite("required_arguments")) {
  argparse::ArgumentParser program("test");
  program.add_argument("--output", "-o")
